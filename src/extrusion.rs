        ...
        for part in &self.parts {
            ...
            match part {
                ...
                Model::Area(area) => {
                    ...
                    let translated_mesh_vec = get_translated_vector(&mesh.vector, self.direction, self.length);
            ...
            for polyline in polylines {
                ...
                let translated_polyline = get_translated_vector(&polyline, self.direction, self.length);
