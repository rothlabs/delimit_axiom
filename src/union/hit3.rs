    ...
    fn get_hit_curve(&self, f0: &usize, f1: &usize, first_hit: &Facet_Hit) -> (CurveShape, CurveShape) {
        ...
        'dir_loop: for direction in 0..2 {
            ...
            'walk_loop: for k in 0..120 {
                ...
                (uv0, p0, dir0) = self.get_walked_point(facet0, target, uv0, p0, dir0, speed0);
                (uv1, p1, dir1) = self.get_walked_point(facet1, target, uv1, p1, dir1, speed1);
                // if hit_limit0 {
                //     (uv1, p1, _) = self.get_walked_point(facet1, p0, uv1, p1);
                // }
                // if hit_limit1 {
                //     (uv0, p0, _) = self.get_walked_point(facet0, p1, uv0, p0);
                // }
                ...
                if break_walk {break}
                //if hit_limit0 || hit_limit1 {break}
            }
        }
