...
use crate::{CurveShape, Shape, Spatial2};
use super::{intersection2::Intersection2, CurveRange};
use glam::*;
...
impl UnionBasis2 { 
    ...
    fn get_spatial_map(&mut self) -> Spatial2 { 
        let mut spatial_map: Spatial2 = Spatial2::new(self.cell_size); 
